...
<body>
	<header><div class="mynd"><img src="/static/logo.svg"></div></header>
	<section class="wrapper-panta">
		<article>
			...
			<h1>Panta hér</h1>
			<form action="/kvittun">
					Fullt nafn: <input type="text" name="name" placeholder="Óðinn Ingi Pétursson" title="Sláðu inn nafn" required>
					Heimilisfang: <input type="text" name="heimilisfang" placeholder="Hellisgerði 11" title="Sláðu inn heimilisfang" required>
					Bæjarfélag: <input type="text" name="baer" placeholder="Hafnarfjordur" title="Sláðu inn heimilisfang"  required>
					Simi: <input type="simi" name="simi" placeholder="123 4567" pattern="\d{3}(?:[\-\s]?)\d{4}" title="Sláðu inn 7 tölustafi" required>
					Email: <input type="email" name="email" placeholder="abc@abc.com" title="Sláðu inn email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
					<h1>Pizzustærð</h1>
					...
					<div class="alegg">
						...
						<div class="kjot">
							<h3>Kjöt</h3>
							<input type="checkbox" name="alegg" id="pepparoni" value="pepparoni"><label for="pepparoni">Pepparoni</label><br>
